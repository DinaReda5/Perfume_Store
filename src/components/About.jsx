...
const About = () => {
    return (
        ...
        <section id='about' className='min-h-screen scroll-mt-20 bg-gradient-to-b from-gray-50 to-white
                ...
                <div className='flex flex-col lg:flex-row gap-12 mb-20'>
                    ...
                    <div className='lg:w-1/2 flex flex-col justify-center'>
                        ...
                        <p className='text-lg text-gray-600 mb-4'>
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Officia eveniet totam,
                            quos nesciunt doloribus necessitatibus rerum. Ut et quam sapiente? Numquam sit eligendi natus.
                            Tenetur maxime quasi aut eveniet?
                        </p>
